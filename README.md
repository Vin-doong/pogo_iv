...
- **로켓 라인업** — GO 로켓단 보스/간부/조무래기 슬롯별 가능 포켓몬, 색이다른(★)/획득가능(💎) 표시. 더블클릭 시 PvE 로켓 카운터 자동 연동
